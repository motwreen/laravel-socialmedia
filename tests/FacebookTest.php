...
use Motwreen\Socialmedia\Facades\Socialmedia;

class FacebookTest extends Orchestra\Testbench\TestCase {
    protected function getPackageProviders($app)
    {
        return ['Motwreen\Socialmedia\Providers\SocialmediaServiceProvider'];
    }

    protected function getPackageAliases($app)
    {
        return [
            'Socialmedia' => 'Motwreen\Socialmedia\Facades\Socialmedia'
        ];
    }
    ...
    public function testFacebookPost()
    {
        ...
        $client = new GuzzleHttp\Client(['base_uri' => 'https://graph.facebook.com/v2.11/']);
